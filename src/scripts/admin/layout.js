...
$("#credit-section").css('display', 'none');
...
$("#currentStockReport").css('display', 'none');
$("#creditReport").css('display', 'none');
$("#stockReport").css('display', 'none');
$("#cashSettlementReport").css('display', 'none');
$("#salesReport").css('display', 'none');
$("#incomeReport").css('display', 'none');
$("#expensesReport").css('display', 'none');
$("#orderDetailsReport").css('display', 'none');
$("#creditPaymentReport").css('display', 'none');
$("#table-section").css('display', 'none');
$("#dishReport").css('display', 'none');
...
//Admin navigation to customer view
...
$("#btn-adminTable").click('on', function () {
    $("#dashboard-section").css('display', 'none');
    $("#employee-section").css('display', 'none');
    $("#dish-section").css('display', 'none');
    $("#stock-section").css('display', 'none');
...
$("#btn-adminCredit").click('on', function () {
    $("#dashboard-section").css('display', 'none');
    $("#employee-section").css('display', 'none');
    $("#dish-section").css('display', 'none');
    $("#stock-section").css('display', 'none');
    ...
    $("#orderDetailsReport").css('display', 'none');
    $("#table-section").css('display', 'none');
    $("#credit-section").css('display', 'block');
    $("#creditPaymentReport").css('display', 'none');
    $("#dishReport").css('display', 'none');
});
